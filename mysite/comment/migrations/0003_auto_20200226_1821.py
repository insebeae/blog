...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0002_auto_20200225_2236'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply_comment', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='comment',
            name='root',
